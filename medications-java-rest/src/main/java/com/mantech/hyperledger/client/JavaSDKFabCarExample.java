...
//    private static final String HOSTNAME = "172.20.180.34";
    ...
    public static void main(String[] args) throws Exception {
        ...
        HFCAClient caClient = getHfCaClient(URL_ROOT+":7054", null);
        ...
        AppUser appUser = getUser(caClient, admin, "user2");
        log.info(appUser);
    ...
    static Channel getChannel(HFClient client) throws InvalidArgumentException, TransactionException {
        ...
        Peer peer = client.newPeer("peer0.org1.example.com", GRCP_ROOT+":7051");
        // eventhub name and endpoint in fabcar network
     //   EventHub eventHub = client.newEventHub("eventhub01", GRCP_ROOT+":7053");
        // orderer name and endpoint in fabcar network
        Orderer orderer = client.newOrderer("orderer.example.com", GRCP_ROOT+":7050");
